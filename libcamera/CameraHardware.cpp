...
void CameraHardware::initDefaultParameters(int CameraID)
{
	...
	if(CameraID==CAMERA_FF)
	{
        ...
        p.set(CameraParameters::KEY_FOCUS_DISTANCES,FRONT_CAMERA_FOCUS_DISTANCES_STR);
...
status_t CameraHardware::setParameters(const CameraParameters& params)
{
    ...
    if (new_white_str != NULL) {
        ...
        else if (!strcmp(new_white_str,(const char *)CameraParameters::WHITE_BALANCE_DAYLIGHT))
            new_white = WHITE_BALANCE_SUNNY;
        else if (!strcmp(new_white_str,(const char *)CameraParameters::WHITE_BALANCE_CLOUDY_DAYLIGHT))
            new_white = WHITE_BALANCE_CLOUDY;
        else if (!strcmp(new_white_str,(const char *)CameraParameters::WHITE_BALANCE_FLUORESCENT))
            new_white = WHITE_BALANCE_FLUORESCENT;
        else if (!strcmp(new_white_str,(const char *) CameraParameters::WHITE_BALANCE_INCANDESCENT))
